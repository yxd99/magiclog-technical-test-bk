...
export const WARNING_DYNAMIC_RESULT_SETS_RETURNED = '0100C';
export const WARNING_IMPLICIT_ZERO_BIT_PADDING = '01008';
export const WARNING_NULL_VALUE_ELIMINATED_IN_SET_FUNCTION = '01003';
export const WARNING_PRIVILEGE_NOT_GRANTED = '01007';
export const WARNING_PRIVILEGE_NOT_REVOKED = '01006';
export const WARNING_STRING_DATA_RIGHT_TRUNCATION = '01004';
export const WARNING_DEPRECATED_FEATURE = '01P01';
...
export const DATA_EXCEPTION_ARRAY_SUBSCRIPT_ERROR = '2202E';
export const DATA_EXCEPTION_CHARACTER_NOT_IN_REPERTOIRE = '22021';
export const DATA_EXCEPTION_DATETIME_FIELD_OVERFLOW = '22008';
export const DATA_EXCEPTION_DIVISION_BY_ZERO = '22012';
export const DATA_EXCEPTION_ERROR_IN_ASSIGNMENT = '22005';
export const DATA_EXCEPTION_ESCAPE_CHARACTER_CONFLICT = '2200B';
export const DATA_EXCEPTION_INDICATOR_OVERFLOW = '22022';
export const DATA_EXCEPTION_INTERVAL_FIELD_OVERFLOW = '22015';
export const DATA_EXCEPTION_INVALID_ARGUMENT_FOR_LOGARITHM = '2201E';
export const DATA_EXCEPTION_INVALID_ARGUMENT_FOR_NTILE_FUNCTION = '22014';
export const DATA_EXCEPTION_INVALID_ARGUMENT_FOR_NTH_VALUE_FUNCTION = '22016';
export const DATA_EXCEPTION_INVALID_ARGUMENT_FOR_POWER_FUNCTION = '2201F';
export const DATA_EXCEPTION_INVALID_ARGUMENT_FOR_WIDTH_BUCKET_FUNCTION =
  '2201G';
export const DATA_EXCEPTION_INVALID_CHARACTER_VALUE_FOR_CAST = '22018';
export const DATA_EXCEPTION_INVALID_DATETIME_FORMAT = '22007';
export const DATA_EXCEPTION_INVALID_ESCAPE_CHARACTER = '22019';
export const DATA_EXCEPTION_INVALID_ESCAPE_OCTET = '2200D';
export const DATA_EXCEPTION_INVALID_ESCAPE_SEQUENCE = '22025';
export const DATA_EXCEPTION_NONSTANDARD_USE_OF_ESCAPE_CHARACTER = '22P06';
export const DATA_EXCEPTION_INVALID_INDICATOR_PARAMETER_VALUE = '22010';
export const DATA_EXCEPTION_INVALID_PARAMETER_VALUE = '22023';
export const DATA_EXCEPTION_INVALID_REGULAR_EXPRESSION = '2201B';
export const DATA_EXCEPTION_INVALID_ROW_COUNT_IN_LIMIT_CLAUSE = '2201W';
export const DATA_EXCEPTION_INVALID_ROW_COUNT_IN_RESULT_OFFSET_CLAUSE = '2201X';
export const DATA_EXCEPTION_INVALID_TIME_ZONE_DISPLACEMENT_VALUE = '22009';
export const DATA_EXCEPTION_INVALID_USE_OF_ESCAPE_CHARACTER = '2200C';
export const DATA_EXCEPTION_MOST_SPECIFIC_TYPE_MISMATCH = '2200G';
export const DATA_EXCEPTION_NULL_VALUE_NOT_ALLOWED = '22004';
export const DATA_EXCEPTION_NULL_VALUE_NO_INDICATOR_PARAMETER = '22002';
export const DATA_EXCEPTION_NUMERIC_VALUE_OUT_OF_RANGE = '22003';
export const DATA_EXCEPTION_STRING_DATA_LENGTH_MISMATCH = '22026';
export const DATA_EXCEPTION_STRING_DATA_RIGHT_TRUNCATION = '22001';
export const DATA_EXCEPTION_SUBSTRING_ERROR = '22011';
export const DATA_EXCEPTION_TRIM_ERROR = '22027';
export const DATA_EXCEPTION_UNTERMINATED_C_STRING = '22024';
export const DATA_EXCEPTION_ZERO_LENGTH_CHARACTER_STRING = '2200F';
export const DATA_EXCEPTION_FLOATING_POINT_EXCEPTION = '22P01';
export const DATA_EXCEPTION_INVALID_TEXT_REPRESENTATION = '22P02';
export const DATA_EXCEPTION_INVALID_BINARY_REPRESENTATION = '22P03';
export const DATA_EXCEPTION_BAD_COPY_FILE_FORMAT = '22P04';
export const DATA_EXCEPTION_UNTRANSLATABLE_CHARACTER = '22P05';
export const DATA_EXCEPTION_NOT_AN_XML_DOCUMENT = '2200L';
export const DATA_EXCEPTION_INVALID_XML_DOCUMENT = '2200M';
export const DATA_EXCEPTION_INVALID_XML_CONTENT = '2200N';
export const DATA_EXCEPTION_INVALID_XML_COMMENT = '2200S';
export const DATA_EXCEPTION_INVALID_XML_PROCESSING_INSTRUCTION = '2200T';
...
export const RUNTIME_EXCEPTION_FUNCTION_EXECUTED_NO_RETURN_STATEMENT = '2F005';
export const RUNTIME_EXCEPTION_MODIFYING_SQL_DATA_NOT_PERMITTED = '2F002';
export const RUNTIME_EXCEPTION_PROHIBITED_SQL_STATEMENT_ATTEMPTED = '2F003';
export const RUNTIME_EXCEPTION_READING_SQL_DATA_NOT_PERMITTED = '2F004';
